...
import logoYellow from '../img/logo--yellow.jpg';
...
function App() {
  ...
  // Handles and updates changes at countrySelection form
  ...
  // Posts created SVG element to express server and shows feedback message that SVG file is saved
  function saveSVG(e) {
    e.preventDefault();
  ...
  // React component consists of Header, Form, Save Button and Matrix
  return (
