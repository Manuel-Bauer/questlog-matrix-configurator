...
function Form(props) {
  ...
  return (
     <form className="form">
       ...
       <option className="option" value="">-- Country 1 --</option>
       ...
       <option className="option" value="">-- Country 2 --</option>
       {createSelections(props.countries)}
       </select>
       ...
       <option className="option" value="">-- Country 3 --</option>
       {createSelections(props.countries)}
       </select>
       ...
       <option className="option" value="">-- Country 4 --</option>
       {createSelections(props.countries)}
       </select>
       ...
       <option className="option" value="">-- Country 5 --</option>
       {createSelections(props.countries)}
       </select>
       ...
       <option className="option" value="">-- Country 6 --</option>
       {createSelections(props.countries)}
       </select>
       ...
       <option className="option" value="">-- Country 7 --</option>
       {createSelections(props.countries)}
       </select>
       ...
       <option className="option" value="">-- Country 8 --</option>
       {createSelections(props.countries)}
       </select>
       ...
       <option className="option" value="">-- Country 9 --</option>
       {createSelections(props.countries)}
       </select>
     </form>
  )
